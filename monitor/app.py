...
def lambda_handler(event: dict, context: LambdaContext) -> dict:
    ...
    #metrics.add_metric(name="Backups", unit=MetricUnit.Count, value=1) #each time a backup file is copied to S3, push a custom metric with value of 1
    ...
    with single_metric(name="Backups", unit=MetricUnit.Count, value=1) as metric:
        metric.add_dimension(name="System", value=system_name)
    print ("Pushed metric and dimension for: " + system_name)
